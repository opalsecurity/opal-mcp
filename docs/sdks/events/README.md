...
* [getEvent](#getevent) - Get event by ID
...
<!-- UsageSnippet language="typescript" operationID="events" method="get" path="/events" example="withDate" -->
```typescript
...
<!-- UsageSnippet language="typescript" operationID="events" method="get" path="/events" example="withDatetime" -->
```typescript
import { OpalMcp } from "opal-mcp";
...
<!-- UsageSnippet language="typescript" operationID="getEvent" method="get" path="/events/{event_id}" -->
```typescript
import { OpalMcp } from "opal-mcp";
...
async function run() {
  const result = await opalMcp.events.getEvent({
...
```typescript
import { OpalMcpCore } from "opal-mcp/core.js";
import { eventsGetEvent } from "opal-mcp/funcs/eventsGetEvent.js";
...
async function run() {
  const res = await eventsGetEvent(opalMcp, {
    eventId: "29827fb8-f2dd-4e80-9576-28e31e9934ac",
  });
  if (res.ok) {
    const { value: result } = res;
