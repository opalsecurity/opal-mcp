...
* [getAccessRules](#getaccessrules) - Returns a list of access rules for your organization.
...
<!-- UsageSnippet language="typescript" operationID="get_access_rules" method="get" path="/access-rules" -->
```typescript
...
async function run() {
  const result = await opalMcp.accessRules.getAccessRules({
...
import { accessRulesGetAccessRules } from "opal-mcp/funcs/accessRulesGetAccessRules.js";
...
async function run() {
  const res = await accessRulesGetAccessRules(opalMcp, {
    cursor: "cD0yMDIxLTAxLTA2KzAzJTNBMjQlM0E1My40MzQzMjYlMkIwMCUzQTAw",
    pageSize: 200,
  });
  if (res.ok) {
    ...
    console.log("accessRulesGetAccessRules failed:", res.error);
  }
}
...
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [operations.GetAccessRulesRequest](../../models/operations/getaccessrulesrequest.md)                                                                                           | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
...
**Promise\<[components.PaginatedAccessRulesList](../../models/components/paginatedaccessruleslist.md)\>**
