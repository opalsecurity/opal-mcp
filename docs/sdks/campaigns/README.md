...
* [updateCampaignItemReviewers](#updatecampaignitemreviewers) - Update campaign item reviewers
...
<!-- UsageSnippet language="typescript" operationID="updateCampaignItemReviewers" method="post" path="/campaigns/{campaign_id}/item-reviewers" -->
```typescript
import { OpalMcp } from "opal-mcp";
...
async function run() {
  const result = await opalMcp.campaigns.updateCampaignItemReviewers({
    campaignId: "f454d283-ca87-4a8a-bdbb-df212eca5353",
...
```typescript
import { OpalMcpCore } from "opal-mcp/core.js";
import { campaignsUpdateCampaignItemReviewers } from "opal-mcp/funcs/campaignsUpdateCampaignItemReviewers.js";
...
async function run() {
  const res = await campaignsUpdateCampaignItemReviewers(opalMcp, {
    campaignId: "f454d283-ca87-4a8a-bdbb-df212eca5353",
    updateCampaignItemReviewersInfo: {
      toAssign: [
        {
  ...
  if (res.ok) {
    ...
    console.log("campaignsUpdateCampaignItemReviewers failed:", res.error);
  }
}
...
| Parameter                                                                                                                                                                      | Type                                                                                                                                                                           | Required                                                                                                                                                                       | Description                                                                                                                                                                    |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [operations.UpdateCampaignItemReviewersRequest](../../models/operations/updatecampaignitemreviewersrequest.md)                                                                 | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
| `options`                                                                                                                                                                      | RequestOptions                                                                                                                                                                 | :heavy_minus_sign:                                                                                                                                                             | Used to set various options for making HTTP requests.                                                                                                                          |
| `options.fetchOptions`                                                                                                                                                         | [RequestInit](https://developer.mozilla.org/en-US/docs/Web/API/Request/Request#options)                                                                                        | :heavy_minus_sign:                                                                                                                                                             | Options that are passed to the underlying HTTP request. This can be used to inject extra headers for examples. All `Request` options, except `method` and `body`, are allowed. |
| `options.retries`                                                                                                                                                              | [RetryConfig](../../lib/utils/retryconfig.md)                                                                                                                                  | :heavy_minus_sign:                                                                                                                                                             | Enables retrying HTTP requests under certain failure conditions.                                                                                                               |
...
**Promise\<[components.UpdateCampaignItemReviewersResult](../../models/components/updatecampaignitemreviewersresult.md)\>**
