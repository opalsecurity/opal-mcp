...
```typescript
import { CreateIdpGroupMappingRequest } from "opal-mcp/models/operations";

let value: CreateIdpGroupMappingRequest = {
...
| `requestBody`                                                                                              | [operations.CreateIdpGroupMappingRequestBody](../../models/operations/createidpgroupmappingrequestbody.md) | :heavy_minus_sign:                                                                                         | N/A                                                                                                        |                                                                                                            |