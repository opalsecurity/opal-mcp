...
export namespace Delegation$ {
  /** @deprecated use `Delegation$inboundSchema` instead. */
  export const inboundSchema = Delegation$inboundSchema;
  /** @deprecated use `Delegation$outboundSchema` instead. */
  export const outboundSchema = Delegation$outboundSchema;
  /** @deprecated use `Delegation$Outbound` instead. */
  export type Outbound = Delegation$Outbound;
}
