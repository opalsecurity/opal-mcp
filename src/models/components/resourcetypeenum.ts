...
export const ResourceTypeEnum = {
  ...
  VaultPolicy: "VAULT_POLICY",
  VaultOidcRole: "VAULT_OIDC_ROLE",
  GitHubEnterpriseRole: "GIT_HUB_ENTERPRISE_ROLE",
  GrafanaFolder: "GRAFANA_FOLDER",
  GrafanaDashboard: "GRAFANA_DASHBOARD",
  GrafanaBasicRole: "GRAFANA_BASIC_ROLE",
  ...
  DatabricksMcpServer: "DATABRICKS_MCP_SERVER",
