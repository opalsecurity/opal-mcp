...
export type CreateGroupInfo = {
   ...
   */
  initialUserIds?: Array<string> | undefined;
};
...
> = z.object({
  ...
  initial_user_ids: z.array(z.string()).optional(),
}).transform((v) => {
  return remap$(v, {
    ...
    "team_id": "teamId",
    "initial_user_ids": "initialUserIds",
  });
});
/** @internal */
export type CreateGroupInfo$Outbound = {
  ...
  initial_user_ids?: Array<string> | undefined;
};
...
> = z.object({
  ...
  initialUserIds: z.array(z.string()).optional(),
}).transform((v) => {
  return remap$(v, {
    ...
    teamId: "team_id",
    initialUserIds: "initial_user_ids",
  });
});
