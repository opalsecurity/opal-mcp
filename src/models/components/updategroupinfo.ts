...
export type UpdateGroupInfo = {
  ...
  /**
   * The ID of the associated configuration template. Set to a UUID to attach or re-point the group to that template. Set to `null` to unlink by forking the template into a private configuration that keeps the current settings. Omit to leave linkage unchanged.
   */
