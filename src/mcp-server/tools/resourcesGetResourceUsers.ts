...
const args = {
  request: operations.GetResourceUsersRequest$inboundSchema,
};

export const tool$resourcesGetResourceUsers: ToolDefinition<typeof args> = {
  name: "resources-get-resource-users",
  description: `Get resource users
