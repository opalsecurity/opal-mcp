 ...
 */
export function requestsCancelRequest(
  client: OpalMcpCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.CancelRequestRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/requests/{id}/cancel")(pathParams);
