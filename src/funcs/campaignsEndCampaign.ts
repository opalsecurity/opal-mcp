 ...
 * ended.
 */
export function campaignsEndCampaign(
  client: OpalMcpCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.EndCampaignRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/campaigns/{campaign_id}/end")(pathParams);
