 ...
 */
export function tagsRemoveGroupTag(
  client: OpalMcpCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.RemoveGroupTagRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/tags/{tag_id}/groups/{group_id}")(pathParams);
