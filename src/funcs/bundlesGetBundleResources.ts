 ...
 */
export function bundlesGetBundleResources(
  client: OpalMcpCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetBundleResourcesRequest$outboundSchema.parse(value),
  ...
  const nextFunc = (
    ...
    const results =
      (responseData as { bundle_resources: unknown }).bundle_resources;
