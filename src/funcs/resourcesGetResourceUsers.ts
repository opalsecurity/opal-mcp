 ...
 */
export function resourcesGetResourceUsers(
  client: OpalMcpCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetResourceUsersRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/resources/{resource_id}/users")(pathParams);
