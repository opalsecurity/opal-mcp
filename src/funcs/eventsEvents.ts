...
> {
  const parsed = safeParse(
    request,
    (value) => operations.EventsRequest$outboundSchema.parse(value),
  ...
  const query = encodeFormQuery({
    "actor_filter": payload.actor_filter,
    "api_token_filter": payload.api_token_filter,
    "cursor": payload.cursor,
    "end_date_filter": payload.end_date_filter,
    "event_type_filter": payload.event_type_filter,
    "object_filter": payload.object_filter,
