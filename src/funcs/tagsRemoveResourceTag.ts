 ...
 */
export function tagsRemoveResourceTag(
  client: OpalMcpCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.RemoveResourceTagRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/tags/{tag_id}/resources/{resource_id}")(pathParams);
