 ...
 * started directly.
 */
export function campaignsStartCampaign(
  client: OpalMcpCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.StartCampaignRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/campaigns/{campaign_id}/start")(pathParams);
