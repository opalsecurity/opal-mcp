 ...
 */
export function resourcesSetResourceMessageChannels(
  client: OpalMcpCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.SetResourceMessageChannelsRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.MessageChannelIDList, {
    explode: true,
  });
