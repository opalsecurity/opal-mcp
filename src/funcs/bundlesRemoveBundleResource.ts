 ...
 */
export function bundlesRemoveBundleResource(
  client: OpalMcpCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.RemoveBundleResourceRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/bundles/{bundle_id}/resources/{resource_id}")(
    pathParams,
  );
