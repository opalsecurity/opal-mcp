 ...
 */
export function resourcesCreateResourceCustomAccessLevel(
  client: OpalMcpCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.CreateResourceCustomAccessLevelRequest$outboundSchema.parse(
        value,
      ),
  ...
  const body = encodeJSON("body", payload.CreateResourceCustomAccessLevelInfo, {
    explode: true,
  });
  ...
  const path = pathToFunc("/resources/{resource_id}/custom-access-levels")(
    pathParams,
  );
