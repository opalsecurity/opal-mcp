...
export class Campaigns extends ClientSDK {
   ...
   */
  async updateCampaignItemReviewers(
    request: operations.UpdateCampaignItemReviewersRequest,
    options?: RequestOptions,
  ): Promise<components.UpdateCampaignItemReviewersResult> {
    return unwrapAsync(campaignsUpdateCampaignItemReviewers(
      this,
      request,
      options,
    ));
